...
import com.jasonpercus.flatlaf.components.FlatButton.ButtonType;
import java.awt.Color;
import javax.swing.*;

/**
 * Subclass of {@link JToggleButton} that provides easy access to FlatLaf
...
public class FlatToggleButton
    ...
    /**
     * Returns whether the button preferred size will be made square
     * (quadratically).
     */
    ...
    /**
     * Specifies whether the button preferred size will be made square
     * (quadratically).
     */
    ...
    /**
     * Returns placement of underline if toggle button type is
     * {@link ButtonType#tab}. If underline placement is not specified, returns
     * {@link #BOTTOM} as the default value.
     *
     * @since 2.3
     */
    public int getTabUnderlinePlacement() {
        return getClientPropertyInt("JToggleButton.tab.underlinePlacement", BOTTOM);
    }

    /**
     * Specifies placement of underline if toggle button type is
     * {@link ButtonType#tab}.
     *
     * @param placement One of the following constants defined in
     * SwingConstants: {@link #TOP}, {@link #LEFT}, {@link #BOTTOM}, or
     * {@link #RIGHT}.
     * @since 2.3
     */
    public void setTabUnderlinePlacement(int placement) {
        putClientProperty("JToggleButton.tab.underlinePlacement", (placement >= 0) ? placement : null);
    }

    /**
     * Returns thickness of underline if toggle button type is
     * {@link ButtonType#tab}.
     */
    ...
    /**
     * Specifies thickness of underline if toggle button type is
     * {@link ButtonType#tab}.
     */
    ...
    /**
     * Returns color of underline if toggle button type is
     * {@link ButtonType#tab}.
     */
    ...
    /**
     * Specifies color of underline if toggle button type is
     * {@link ButtonType#tab}.
     */
    ...
    /**
     * Returns background color if selected and toggle button type is
     * {@link ButtonType#tab}.
     */
    ...
    /**
     * Specifies background color if selected and toggle button type is
     * {@link ButtonType#tab}.
     */
