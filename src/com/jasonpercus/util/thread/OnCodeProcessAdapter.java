...
/**
 * Cette classe implémente {@link OnCodeProcess} ce qui permet d'implémenter un objet ayant certaines caractéristiques d'écoute d'un objet {@link CodeProcessing}.
 * <pre>
 * {@code
 ...
 * @version 1.0
 */
public class OnCodeProcessAdapter<In, StartOut, BeforeOut, DuringOut, AfterOut> implements OnCodeProcess<In, StartOut, BeforeOut, DuringOut, AfterOut>{
...
//METHODES PUBLICS
     ...
     * @param in Correspond au type d'entrée fournit au départ (voir la méthode: {@link CodeProcessing#start(com.jasonpercus.util.thread.OnCodeProcess, java.lang.Object, com.jasonpercus.util.thread.During...) CodeProcessing.start()})
     * @return Retourne null par défaut (à Overrider)
     */
    @Override
