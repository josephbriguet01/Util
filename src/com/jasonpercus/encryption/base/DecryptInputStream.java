 ...
 * @version 1.0
 */
public abstract class DecryptInputStream extends java.io.InputStream implements Comparable<DecryptInputStream> {
...
//ATTRIBUTS PRIVATES
    ...
    /**
     * Correspond à la séquence déchiffrée. Tous les nombres de cette séquence doivent être renvoyé un par un
     */
    private byte[] temp;
    ...
    /**
     * Correspond au nombre d'octets qui composeront la chaîne déchiffrée du stream
     */
    private long size;
...
//CONSTRUCTORS
    /**
     * Crée un flux DecryptInputStream par défaut
     ...
     * @param base Correspond à la base qui servira de chiffrement (ex: s'il s'agit d'une base 64, alors le flux passera d'une base 64 à 256)
     * @throws java.io.IOException Si une erreur d'E/S se produit
     */
    public DecryptInputStream(java.io.InputStream input, Base base) throws java.io.IOException {
        this.id     = cptID++;
        this.base   = base;
        this.input  = input;
...
//METHODES PUBLICS
    ...
    public int read() throws java.io.IOException {
        ...
        if(temp == null){
            if(rest <= 0)
                ...
                position = 0;
                do{
                    temp = base.nextByteToDecrypt((byte) input.read());
                    inputAvailable--;
    ...
    /**
     * Détermine si deux DecryptInputStream sont identiques ou pas
     * @param obj Correspond au second objet DecryptInputStream à comparer au courant
    ...
    public boolean equals(Object obj) {
        ...
        final DecryptInputStream other = (DecryptInputStream) obj;
        return this.id == other.id;
    }

    /**
     * Renvoie un DecryptInputStream objet sous la forme d'une chaîne de caractères
     * @return Retourne un DecryptInputStream objet sous la forme d'une chaîne de caractères
     */
    @Override
    ...
    /**
     * Compare deux DecryptInputStream
     * @param o Correspond au second DecryptInputStream à comparer au courant
     * @return Retourne le résultat de la comparaison
     */
    @Override
    public int compareTo(DecryptInputStream o) {
        if(this.id < o.id)
            return -1;
