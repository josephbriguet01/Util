...
public class JIPBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( com.jasonpercus.network.swing.JIP.class , null ); // NOI18N
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", com.jasonpercus.network.swing.JIP.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", com.jasonpercus.network.swing.JIP.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", com.jasonpercus.network.swing.JIP.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", com.jasonpercus.network.swing.JIP.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_bloc] = new IndexedPropertyDescriptor ( "bloc", com.jasonpercus.network.swing.JIP.class, null, null, "getBloc", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", com.jasonpercus.network.swing.JIP.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", com.jasonpercus.network.swing.JIP.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_caret] = new PropertyDescriptor ( "caret", com.jasonpercus.network.swing.JIP.class, "getCaret", "setCaret" ); // NOI18N
            properties[PROPERTY_caretColor] = new PropertyDescriptor ( "caretColor", com.jasonpercus.network.swing.JIP.class, "getCaretColor", "setCaretColor" ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", com.jasonpercus.network.swing.JIP.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", com.jasonpercus.network.swing.JIP.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", com.jasonpercus.network.swing.JIP.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", com.jasonpercus.network.swing.JIP.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", com.jasonpercus.network.swing.JIP.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledTextColor] = new PropertyDescriptor ( "disabledTextColor", com.jasonpercus.network.swing.JIP.class, "getDisabledTextColor", "setDisabledTextColor" ); // NOI18N
            properties[PROPERTY_dot] = new IndexedPropertyDescriptor ( "dot", com.jasonpercus.network.swing.JIP.class, null, null, "getDot", null ); // NOI18N
            properties[PROPERTY_editable] = new PropertyDescriptor ( "editable", com.jasonpercus.network.swing.JIP.class, "isEditable", "setEditable" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", com.jasonpercus.network.swing.JIP.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", com.jasonpercus.network.swing.JIP.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", com.jasonpercus.network.swing.JIP.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", com.jasonpercus.network.swing.JIP.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", com.jasonpercus.network.swing.JIP.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", com.jasonpercus.network.swing.JIP.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_highlighter] = new PropertyDescriptor ( "highlighter", com.jasonpercus.network.swing.JIP.class, "getHighlighter", "setHighlighter" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", com.jasonpercus.network.swing.JIP.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", com.jasonpercus.network.swing.JIP.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", com.jasonpercus.network.swing.JIP.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", com.jasonpercus.network.swing.JIP.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", com.jasonpercus.network.swing.JIP.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", com.jasonpercus.network.swing.JIP.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", com.jasonpercus.network.swing.JIP.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", com.jasonpercus.network.swing.JIP.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", com.jasonpercus.network.swing.JIP.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", com.jasonpercus.network.swing.JIP.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", com.jasonpercus.network.swing.JIP.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", com.jasonpercus.network.swing.JIP.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", com.jasonpercus.network.swing.JIP.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", com.jasonpercus.network.swing.JIP.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_selectedTextColor] = new PropertyDescriptor ( "selectedTextColor", com.jasonpercus.network.swing.JIP.class, "getSelectedTextColor", "setSelectedTextColor" ); // NOI18N
            properties[PROPERTY_selectionColor] = new PropertyDescriptor ( "selectionColor", com.jasonpercus.network.swing.JIP.class, "getSelectionColor", "setSelectionColor" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", com.jasonpercus.network.swing.JIP.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", com.jasonpercus.network.swing.JIP.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_spacePoints] = new PropertyDescriptor ( "spacePoints", com.jasonpercus.network.swing.JIP.class, "getSpacePoints", null ); // NOI18N
            properties[PROPERTY_text] = new PropertyDescriptor ( "text", com.jasonpercus.network.swing.JIP.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", com.jasonpercus.network.swing.JIP.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", com.jasonpercus.network.swing.JIP.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", com.jasonpercus.network.swing.JIP.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", com.jasonpercus.network.swing.JIP.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_wheelMouseChangeIp] = new PropertyDescriptor ( "wheelMouseChangeIp", com.jasonpercus.network.swing.JIP.class, "isWheelMouseChangeIp", "setWheelMouseChangeIp" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", com.jasonpercus.network.swing.JIP.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", com.jasonpercus.network.swing.JIP.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", com.jasonpercus.network.swing.JIP.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_actionListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "actionListener", java.awt.event.ActionListener.class, new String[] {"actionPerformed"}, "addActionListener", "removeActionListener" ); // NOI18N
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_caretListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "caretListener", javax.swing.event.CaretListener.class, new String[] {"caretUpdate"}, "addCaretListener", "removeCaretListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( com.jasonpercus.network.swing.JIP.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_discreaseSpacePoints25] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("discreaseSpacePoints", new Class[] {})); // NOI18N
            ...
            methods[METHOD_getText59] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("getText", new Class[] {int.class, int.class})); // NOI18N
            ...
            methods[METHOD_hasFocus65] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("hasFocus", new Class[] {})); // NOI18N
            ...
            methods[METHOD_increaseSpacePoints68] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("increaseSpacePoints", new Class[] {})); // NOI18N
            ...
            methods[METHOD_requestFocus122] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("requestFocus", new Class[] {boolean.class})); // NOI18N
            methods[METHOD_requestFocus122].setDisplayName ( "" );
            methods[METHOD_requestFocus123] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("requestFocus", new Class[] {})); // NOI18N
            methods[METHOD_requestFocus123].setDisplayName ( "" );
            methods[METHOD_requestFocusInWindow124] = new MethodDescriptor(com.jasonpercus.network.swing.JIP.class.getMethod("requestFocusInWindow", new Class[] {})); // NOI18N
    ...
    private static String iconNameC16 = "/com/jasonpercus/network/swing/JIP_c16.png";//GEN-BEGIN:Icons
    private static String iconNameC32 = "/com/jasonpercus/network/swing/JIP_c32.png";
    private static String iconNameM16 = "/com/jasonpercus/network/swing/JIP_m16.png";
    private static String iconNameM32 = "/com/jasonpercus/network/swing/JIP_m32.png";//GEN-END:Icons
